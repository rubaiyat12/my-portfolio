      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          <form
            target="_blank"
            onSubmit={onSubmit}
            action="https://formsubmit.co//rubaiyatraha12@gmail.com"
            method="POST"
          >
            <input
            ...
            <textarea
              className="w-full bg- font-semibold placeholder-opaque-black p-3 mt-5"
              name="message"
              placeholder="MESSAGE"
              rows="4"
              cols="50"
            ...
            <button
              className="p-4  font-semibold text-deep-blue mt-5 hover:bg-red hover:text-white transition duration-500 rounded-r-sm bg-gradient-rainblue "
              type="submit"
            >
              SEND ME A MESSAGE
            </button>
